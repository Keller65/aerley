...
downloadButton.addEventListener("click", async () => {
  try {
    ...
    const filePath = "gs://imra-database.appspot.com/MySql.pdf";
    ...
    downloadLink.download = "MySql Manual (IMRA)";
    downloadLink.click();
...
downloadApp.addEventListener("click", async () => {
  try {
    // Ruta del archivo que deseas descargar
    const filePath = "gs://imra-database.appspot.com/tutorialApp.exe";
    ...
    const downloadLink = document.createElement("a");
    downloadLink.href = downloadURL;
    downloadLink.download = "MySql + Python App (IMRA)";
    downloadLink.click();
    console.log("Archivo Descargado");
  } catch (error) {
    console.error("Error al descargar el archivo:", error);
